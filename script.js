...
const planetInfoData = {
  ...
  'jupiter': { name: 'Jupiter', info: 'Jupiter is the massive gas giant and the fifth planet from the Sun. It is composed primarily of hydrogen and helium and has a mass more than two and a half times that of all the other planets combined. The Great Red Spot is a colossal storm that has been raging continuously for at least 400 years. Jupiter has an incredibly strong magnetic field and at least 95 known moons, including the Galilean moons: Io, Europa, Ganymede, and Callisto.' },
  'saturn': { name: 'Saturn', info: 'Saturn is the sixth planet from the Sun, mostly famous for its absolutely stunning and extensive ring system. The rings are predominantly composed of glittering ice particles, rocky debris, and cosmic dust. It is a massive gas giant with an average radius about nine and a half times that of Earth. Saturn has 146 confirmed moons, with Titan being the largest and the only moon in the solar system with a substantial atmosphere.' },
  'uranus': { name: 'Uranus', info: 'Uranus is the seventh planet from the Sun and the first planet discovered using a telescope. It is classified as an ice giant because it contains a higher proportion of "ices" such as water, ammonia, and methane. Its unique feature is its severe axial tilt of 97.7 degrees, meaning it basically rotates on its side, resulting in extreme 21-year seasons. Uranus has faint planetary rings and 28 known moons.' },
